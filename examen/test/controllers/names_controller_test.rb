...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { moonNames: @name.moonNames, planetNames: @name.planetNames, starNames: @name.starNames, system_id: @name.system_id } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { moonNames: @name.moonNames, planetNames: @name.planetNames, starNames: @name.starNames, system_id: @name.system_id } }
